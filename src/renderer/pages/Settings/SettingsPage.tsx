                ...
                <div style={{ marginTop: 'var(--space-3)', paddingTop: 'var(--space-3)', borderTop: '1px solid var(--color-surface-border)', fontSize: '13px' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <span style={{ fontFamily: 'monospace' }}>
                      {licenseInfo.licenseKey ? 'ïïïï-ïïïï-ïïïï-' + licenseInfo.licenseKey.slice(-4) : 'N/A'}
                    </span>
                  </div>
                </div>
              )}
...
function NDISettingsPanel() {
  ...
  return (
    ...
    >
      <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
        <p style={{ color: 'var(--color-text-secondary)', margin: 0 }}>
          Transmit the canonical Program Output over the local network using NewTek NDI¬Æ.
...
function DataManagementPanel() {
  ...
  return (
    <Panel 
      title={<span style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>üóÑÔ∏è Data Import & Export</span>}
    >
      <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
        <p style={{ color: 'var(--color-text-secondary)', margin: 0 }}>
